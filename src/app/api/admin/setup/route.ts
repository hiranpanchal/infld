...
// One-time setup endpoint — seeds admin user, products, and default content
...
export async function POST(req: NextRequest) {
  ...
  const productsData = [
    {
      ...
      category: "hoodies",
      badge: "NEW DROP",
      description: "Heavyweight 400gsm organic cotton. Oversized fit. Screen-printed front and back. This hoodie doesn't try to be anything. It just is.",
      materialDetails: "400gsm organic cotton fleece. Brushed interior. Reinforced seams. YKK hardware.",
      sizingDetails: "Oversized fit — we recommend your usual size for the intended baggy look. Age 7-8 (128cm), 9-10 (140cm), 11-12 (152cm), 13-14 (164cm), 15 (170cm).",
      returnDetails: "30-day returns. Unworn, tags attached. We'll sort it. No drama.",
    ...
    },
    {
      ...
      category: "hoodies",
      badge: null,
      description: "Same heavyweight build. Different statement. Off-white colourway with black screen print.",
      materialDetails: "400gsm organic cotton fleece. Brushed interior. Reinforced seams. YKK hardware.",
      sizingDetails: "Oversized fit — we recommend your usual size. Age 7-8 (128cm), 9-10 (140cm), 11-12 (152cm), 13-14 (164cm), 15 (170cm).",
      returnDetails: "30-day returns. Unworn, tags attached. We'll sort it. No drama.",
      sizes: ["7-8", "9-10", "11-12", "13-14", "15"],
    },
    {
      ...
      category: "tees",
      badge: "NEW DROP",
      description: "200gsm organic cotton tee. Boxy fit. Bold graphic front, minimal back.",
      materialDetails: "200gsm organic cotton jersey. Pre-shrunk. Screen-printed.",
      sizingDetails: "Boxy/relaxed fit. Age 7-8 (128cm), 9-10 (140cm), 11-12 (152cm), 13-14 (164cm), 15 (170cm).",
      returnDetails: "30-day returns. Unworn, tags attached. We'll sort it. No drama.",
      sizes: ["7-8", "9-10", "11-12", "13-14", "15"],
    },
    {
      ...
      category: "tees",
      badge: null,
      description: "Same boxy cut. Off-white colourway. High-contrast print.",
      materialDetails: "200gsm organic cotton jersey. Pre-shrunk. Screen-printed.",
      sizingDetails: "Boxy/relaxed fit. Age 7-8 (128cm), 9-10 (140cm), 11-12 (152cm), 13-14 (164cm), 15 (170cm).",
      returnDetails: "30-day returns. Unworn, tags attached. We'll sort it. No drama.",
      sizes: ["7-8", "9-10", "11-12", "13-14", "15"],
    },
    {
      ...
      badge: "LIMITED",
      description: "Limited run. Hand-numbered. Once they're gone, they're gone.",
      materialDetails: "450gsm heavyweight organic cotton. Hand-distressed details. Numbered label sewn in.",
      sizingDetails: "Oversized fit. Age 9-10 (140cm), 11-12 (152cm), 13-14 (164cm), 15 (170cm). Limited sizes.",
      returnDetails: "Final sale on Rebel Edition. Choose carefully. That's the point.",
    ...
    },
    {
      ...
      category: "rebel-edition",
      badge: "LIMITED",
      description: "Limited edition graphic tee with hand-finished details. Numbered.",
      materialDetails: "220gsm organic cotton. Hand-distressed collar. Numbered interior label.",
      sizingDetails: "Boxy fit. Age 9-10 (140cm), 11-12 (152cm), 13-14 (164cm), 15 (170cm).",
      returnDetails: "Final sale on Rebel Edition. Choose carefully. That's the point.",
      sizes: ["9-10", "11-12", "13-14", "15"],
    },
  ];
  ...
  for (const p of productsData) {
    ...
    const product = await prisma.product.upsert({
      where: { slug: p.slug },
      update: {},
      create: { ...productData, published: true },
    });
    const existingSizes = await prisma.productSize.count({ where: { productId: product.id } });
    if (existingSizes === 0) {
      await prisma.productSize.createMany({
        data: sizes.map((label) => ({ productId: product.id, label, stock: 50 })),
      });
    }
  }
  ...
  return NextResponse.json({ ok: true, message: "Setup complete — admin user, 6 products, and all page content seeded." });
}
